...
public class MahasiswaController {
    ...
    public void saveMahasiswa() {
        ...
        JOptionPane.showMessageDialog(null, "Data Berhasil Disimpan", "Info", JOptionPane.WARNING_MESSAGE);
        clear();
        tampilData();
    }
    ...
    public void updateMahasiswa() {
        ...
        JOptionPane.showMessageDialog(null, "Data Berhasil Diupdate", "Info", JOptionPane.WARNING_MESSAGE);
        clear();
        tampilData();
    }
    ...
    public void deleteMahasiswa() {
        ...
        if (this.mahasiswaView.getNpm().getText() == null) {
            ...
            if (pilih == JOptionPane.YES_OPTION) {
                ...
                JOptionPane.showMessageDialog(null, "Data Berhasil Dihapus", "Info", JOptionPane.WARNING_MESSAGE);
                clear();
                tampilData();
            }
        }
